(function(){
	...
	$('form textarea').each(function(i,el) {
		...
		el.form.editor = CodeMirror.fromTextArea(el, { lineNumbers: false, mode: mode });
	...
	//shamelessly taken from Learning Advanced JavaScript (http://ejohn.org/apps/learn/) by John Resig
	var stasis = {};
	...
	jQuery('form').submit(function(e){
		console.clear();
		try {
			(new Function( jQuery('textarea', this).val() ))();
		} catch(e){
